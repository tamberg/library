...
- User: who borrows items (GitHub users with the right to search and read files, open an issue)
- Admin: who lends items (GitHub users with the right to edit and add files to repository, tag an issue)
