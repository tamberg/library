...
- Keep it simple
- Use GitHub features
- [Pre-fill](https://stackoverflow.com/questions/34146618/pre-populate-the-github-new-issue-form-using-the-querystring), [label](https://github.com/tamberg/library/labels) to save time
