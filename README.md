...
- User: borrows items (GitHub users with the right to search and read files, open an issue)
- Admin: lends items (GitHub users with the right to edit and add files to repository, tag an issue)
