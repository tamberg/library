...
- User: who borrows items (GitHub user with right to search and read files, open an issue)
- Admin: who lends items (GitHub user with right to edit and add files to repository, tag an issue)
